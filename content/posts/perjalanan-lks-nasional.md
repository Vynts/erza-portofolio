...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 my-6">
  <div className="space-y-2">
    <img src="/images/makan-lks-lampung.jpeg" alt="Makan Bareng Delegasi LKS Lampung" className="rounded-lg w-full object-cover aspect-[4/3]" />
    <em className="text-xs sm:text-sm text-[#8b949e] block italic">Kebersamaan hangat saat makan bersama delegasi LKS Lampung di PPSDM.</em>
  </div>
  <div className="space-y-2">
    <img src="/images/foto-bareng-juri.jpeg" alt="Foto bersama Juri Cloud Computing" className="rounded-lg w-full object-cover aspect-[4/3]" />
    <em className="text-xs sm:text-sm text-[#8b949e] block italic">Momen berharga berfoto bersama para praktisi dan juri Cloud Computing nasional.</em>
  </div>
  <div className="space-y-2">
    <img src="/images/naik-pesawat.jpeg" alt="Pengalaman Pertama Penerbangan" className="rounded-lg w-full object-cover aspect-[4/3]" />
    <em className="text-xs sm:text-sm text-[#8b949e] block italic">Perjalanan udara pertama menuju Jakarta membawa nama Provinsi Lampung.</em>
  </div>
</div>