        ...
        <section className="flex flex-col-reverse md:flex-row gap-8 md:gap-12 items-center justify-between">
          <div className="space-y-6 flex-1 text-center md:text-left">
            ...
            <div className="flex gap-5 items-center justify-center md:justify-start pt-2 text-[#8b949e]">
              <a href="mailto:vendzaky@gmail.com" aria-label="Email Alvinza" className="hover:text-[#58a6ff] transition-colors w-6 h-6 flex items-center justify-center">
              ...
              <a href="https://www.youtube.com/@erzaproject" target="_blank" rel="noopener noreferrer" aria-label="YouTube Erza Project" className="hover:text-[#58a6ff] transition-colors w-6 h-6 flex items-center justify-center">
              ...
              <a href="https://github.com/Vynts" target="_blank" rel="noopener noreferrer" aria-label="GitHub Vynts" className="hover:text-[#58a6ff] transition-colors w-6 h-6 flex items-center justify-center">
              ...
              <a href="https://www.instagram.com/erzatora" target="_blank" rel="noopener noreferrer" aria-label="Instagram Alvinza" className="hover:text-[#58a6ff] transition-colors w-6 h-6 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.9 3.9 0 0 0-1.417.923A3.9 3.9 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.093.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.9 3.9 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.9 3.9 0 0 0-.923-1.417A3.9 3.9 0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599s.453.546.598.92c.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.5 2.5 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.5 2.5 0 0 1-.92-.598 2.5 2.5 0 0 1-.599-.92c-.11-.28-.24-.704-.276-1.485-.038-.843-.047-1.096-.047-3.232s.009-2.389.047-3.232c.036-.78.166-1.203.276-1.485a2.5 2.5 0 0 1 .598-.92 2.5 2.5 0 0 1 .92-.598c.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92m-4.27 1.122a4.106 4.106 0 1 0 0 8.212 4.106 4.106 0 0 0 0-8.211m0 1.438a2.668 2.668 0 1 1 0 5.336 2.668 2.668 0 0 1 0-5.336"/>
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/alvinza-erza-farandhika-7a023637a/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Alvinza" className="hover:text-[#58a6ff] transition-colors w-6 h-6 flex items-center justify-center">
